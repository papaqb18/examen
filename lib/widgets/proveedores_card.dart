    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Stack(alignment: Alignment.bottomLeft, children: [
          _ProductDetails(product: proveedor),
          if (proveedor.ProveedorState == 'bloqueado')
            Positioned(top: 0, left: 0, child: _State(product: proveedor))
        ]),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      child: FittedBox(
        ...
        child: Padding(
            padding: const EdgeInsets.symmetric(horizontal: 10),
            child: Text(product.ProveedorName,
